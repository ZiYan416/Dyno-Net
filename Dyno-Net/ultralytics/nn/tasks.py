...
from ultralytics.nn.extra_modules.block import PyramidContextExtraction, DynamicInterpolationFusion, FuseBlockMulti, RCM
...
DETECT_CLASS = (Detect_LSCSBD,)
V10_DETECT_CLASS = ()
SEGMENT_CLASS = (Segment_LSCSBD,)
POSE_CLASS = (Pose_LSCSBD,)
OBB_CLASS = (OBB_LSCSBD,)
C3K2_CLASS = (C3k2_DynoConv,)
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in ((
            ...
            C3x, RepC3, PSA, SCDown, C2fCIB, nn.Conv2d, RepNCSPELAN4,
        ) + C3K2_CLASS):
            if args[0] == 'head_channel':
                args[0] = d[args[0]]
            c1, c2 = ch[f], args[0]
